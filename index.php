...
<body>
    ...
    <!-- 1. Faut mettre l'image ici -->
        <!-- IMAGE DE FOND MIDJOU -->
        <!-- <div class="sticky-hero__media parallax overflow-hidden js-parallax" aria-hidden="true"> -->
        <!-- <div class=" parallax overflow-hidden " aria-hidden="true">
            <figure class="parallax__wrapper relative transition-transform duration-[400ms] ease-out js-parallax__wrapper">
            
                <img class="block w-full js-parallax__item  h-[56em]" src="img/ozanmid.jpg" alt="Image description">
                
                    <h1 class="ml-12 text-2xl md:text-4xl lg:text-9xl xl:text-10xl font-bold text-black text-right font-serif">Étudiant en Cybersécurité</h1>
                    <p class="mb-12 text-xl md:text-2xl lg:text-5xl text-black text-right font-serif">Juste Ozan</p>
                
            </figure>
        </div> -->

        <div style="background-image: url('img/ozanmidjou.jpeg'); background-size:100%;" class="pt-[3%] block w-full sm:h-[30%] lg:h-screen bg-no-repeat" id="sticky-banner-target">
            
            <div class="text-right justify-end">
                <!-- <h1 class=" ml-12 text-3xl md:text-6xl lg:text-7xl xl:text-9xl font-bold text-white text-right font-serif">Étudiant en Cybersécurité</h1> -->
            </div>
        </div>  

    
        <!-- APPARITION DU TEXT / STICKY HERO -->
        <!-- <div class="sticky-hero__content">

            <div class="w-screen ">
                <h1 class="ml-12 text-2xl md:text-4xl lg:text-9xl xl:text-10xl font-bold text-white text-right font-serif">Étudiant en Cybersécurité</h1>
                
                <p class="mb-12 text-xl md:text-2xl lg:text-5xl text-white text-right font-serif">Juste Ozan</p>
                <section class="pt-32">
                    <a href="https://www.instagram.com/juste_ozan/"><img class="h-10 mb-3 text-xl md:text-2xl lg:text-4xl opacity-70" src="img/instagram.png" alt="instagram"></a>
                    <a href="https://www.linkedin.com/in/juste-ozan/"><img  class="h-10 mb-3 text-xl md:text-2xl lg:text-4xl opacity-70" src="img/linkedin.png" alt="linkedin"></a>
                    <a href="https://github.com/osahinGuardia"><img class="h-10 mb-3 text-xl md:text-2xl lg:text-4xl opacity-70" src="img/github.png" alt="github"></a>
                </section>
            </div>
        </div> -->

    <!-- 2. Faut mettre le text qu'on veut -->
        <!-- APPARITION DU TEXT / ANIM.CSS-->
        <!-- <div>
            <h1 class="ml-12 text-2xl md:text-4xl lg:text-9xl xl:text-10xl font-bold text-black text-right font-serif">Étudiant en Cybersécurité</h1>
            <p class="mb-12 text-xl md:text-2xl lg:text-5xl text-black text-right font-serif">Juste Ozan</p>
        </div>
        ...
        <div class="w-[calc(100%_-_2.5rem)] lg:w-[calc(100%_-_4rem)] mx-auto max-w-7xl">
            ...
            <div class="flex flex-col border-t border-gray-300 py-2 lg:py-3 mt-8 lg:mt-12 lg:flex-row lg:justify-between lg:items-center">
                ...
                <div class="flex items-center gap-2 lg:gap-3">
                    <a href="App/404.php" class="main-footer__social">
